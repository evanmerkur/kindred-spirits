    ...
    <div className="pt-32 pb-24 px-6 min-h-screen">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl mb-8 italic">The Heart Behind <br />Kindred Spirits</h1>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            <p>
              Kindred Spirits wasn't born out of a business plan, but out of a lifetime of observation and a deeply rooted family value. 
            </p>
            <p>
        ...
        >
          ...
          <p>
            Kindred Spirits is my way of honoring that legacy. We aren't just providing a service; we are carrying forward a tradition of respect, patience, and genuine companionship. We treat your loved ones the way my father treated ours—with a heart that truly values their presence.
          </p>
